...
namespace RozaMin.ISO3166
{
    ...
    {
        private static readonly Lazy<Country[]> countries = new Lazy<Country[]>(GetAllCountries);

        private static Country[] GetAllCountries()
        {
            return new[]
                {
                    new Country("Afghanistan", TwoLetterCodes.Afghanistan, "AFG", "004"),
                    ...
                    new Country("Iran", TwoLetterCodes.Iran, "IRN", "364"),
                    new Country("Iraq", TwoLetterCodes.Iraq, "IRQ", "368"),
                    ...
                    new Country("United Kingdom of Great Britain and Northern Ireland", TwoLetterCodes.UnitedKingdomOfGreatBritainAndNorthernIreland, "GBR", "826"),
                    ...
                    new Country("Zimbabwe", TwoLetterCodes.Zimbabwe, "ZWE", "716"),
